{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-fea064a1-f530-444b-afc9-55b29a26597a" = [ ];
      ...
      "services/org.kde.spectacle.desktop"."RectangularRegionScreenShot" = "Ctrl+$";
    };
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2024,8,22,18,18,40.089";
      ...
      "kwinrc"."Tiling/27fd6818-813a-5a1c-a177-77f4431f363c"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/ef5f6a83-7cb9-5cae-8202-f076b16c0655"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
