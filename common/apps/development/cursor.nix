{ my-options, ... }: {
  ...
  home-manager.users.${my-options.user.name} = { ... }: {
    ...
    xdg.desktopEntries.cursor.exec = "/home/ephemeral/p-data/application/cursor/Cursor.AppImage --ozone-platform=wayland --enable-features=UseOzonePlatform,WaylandWindowDecorations";
